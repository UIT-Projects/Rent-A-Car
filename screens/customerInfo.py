...
def customerInfo(self):
    ...
    HeadingLabel(self.frame, text='Customer Information')
    input_widget = InputWidgets(self.frame, num_entry_boxes=3)
    ...
    def addData():
        ...
        with open('data/Customer.csv', 'a', newline='') as csvfile:
